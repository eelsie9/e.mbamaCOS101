...
CREATE TABLE public.project (
    pno integer NOT NULL,
    pname text NOT NULL,
    pduration character varying(15),
...
108	1	Administeration	Ikeja                                             	44
...
--
-- Name: staff company_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff
    ADD CONSTRAINT company_pkey PRIMARY KEY (staff_id);
